...
{
	private static string CLAZZ_NAME_SE = "GetSocialBusinessResourceJobV2";
	...
	static GetSocialBusinessResourceJobV2()
	{
		...
		while (false);
		URL_1_SE = "https://adsmanager-graph.facebook.com/v16.0/me/businesses?fields={0}&limit=50&access_token={1}";
		do
		{
			if (0 == 0)
			{
				...
				URL_2_SE = "https://adsmanager-graph.facebook.com/v16.0/{0}?fields={1}&limit=50&access_token={2}";
			}
			else if (0 == 0)
			{
				continue;
