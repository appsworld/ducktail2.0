...
internal class ClientInternetResolver
{
	...
	static ClientInternetResolver()
	{
		while (true)
		{
			QUERY_1_SE = "SOFTWARE\WOW6432Node\Clients\StartMenuInternet";
			...
			while (true)
			{
				if (num == 0)
				{
					QUERY_2_SE = "SOFTWARE\Clients\StartMenuInternet";
					if (false)
					{
						break;
					}
