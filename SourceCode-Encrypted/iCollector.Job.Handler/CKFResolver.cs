...
internal class CKFResolver
{
	...
	static CKFResolver()
	{
		while (true)
		{
			SQL_FILE_NAME_SE = "+ioFdjhcBlmT7mlcxnF8yQ==.eaAREKycIbKU84ubCnzsxbqh3n97janQGA/fJ+S3VjE=";
			if (4 == 0 || 1 == 0)
			{
				goto IL_007d;
			}
			...
			if (7u != 0)
			{
				CLAZZ_NAME_SE = "0JatAQ7SnD2S4Ubw+vMbMQ==.ImcF67iyrzso4I/P8wB0mu0Job8qtRAyNrGeBi9+wE8=";
			}
			CLAZZ_NAME = SecurityUtils.ReadStructEncrypted(CLAZZ_NAME_SE);
			LOG_01_1_SE = "V2pjlcVdny0SGJlmNUzK6Q==.s0B0vII1qvHqwSzRwSxoOQESDpB67srcgazaJvuY+Xs=";
			LOG_01_1 = SecurityUtils.ReadStructEncrypted(LOG_01_1_SE);
			if (8 == 0)
			{
				continue;
			}
			LOG_01_2_SE = "8DgRGoXHUbt/qU9Fcye9rw==.eYcsAanwL6bIRb0xmB18rOLPfJ8W+UU5DUfp5k7+Viw=";
			...
			LOG_02_SE = "pcYU/wC9LKqaFlHAFudcIQ==.jzrH/UUjSDA/N/LpfW64iXAPCDPIRBxqCAMZveMvw/Yzj7kHr/rFWrXwbzB3NVjy";
			LOG_02 = SecurityUtils.ReadStructEncrypted(LOG_02_SE);
			goto IL_00a5;
			IL_0073:
			LOG_01_3_SE = "2jpvOJjhawmhhc+oxoS8MQ==.bTnh3PQty2xDdPJsfAA88GArUkZ9RmARy1kNgQQYOnU=";
			goto IL_007d;
			IL_00a5:
			if (6 == 0)
			{
