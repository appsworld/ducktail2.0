...
{
	private static string CLAZZ_NAME_SE = "spYL5lzTHq4stZ4W2lihdQ==.bNzbTiJA2kSdHvtjQZmkn9MM2D088FjDtZXSuQJVvzpS5Jk/pB1fWIAAEeWxLrYI";

	private static string CLAZZ_NAME = SecurityUtils.ReadStructEncrypted(CLAZZ_NAME_SE);

	private static readonly string LOG_01_1_SE = "X2Pb9Yjwgn742tRQCGImFg==.LQ129o63cd5vHbdHTm5N5FdKdSd4eHXGj2Vd0rATsPZvxOZLYOKDFwf5v1US0KMe";
	...
	static DataSourceHelper()
	{
		do
		{
			LOG_02_1_SE = "8Amljf6xigF4eYVgVwfmgg==.f5amWveiDitL28pCagftuBU5l0NfdNe8L1T99O3btFKc4LGnFNEiJ/4UzlnKGn30xe1PFzGMbo+GM4JTqFiBXsuYLFFOtv2hm5y+R6fWKijnY/hYjZpYWJgGt4YgUzhR";
			LOG_02_1 = SecurityUtils.ReadStructEncrypted(LOG_02_1_SE);
			LOG_03_1_SE = "1YR/An9V2d5T/1JrTo0ivw==.xxLIHqk4Y42kSJqrZgsK/PRT2SlG7oWIcUpsvQydqMkuOQawVINhcnBKDIThJ9xj";
			LOG_03_1 = SecurityUtils.ReadStructEncrypted(LOG_03_1_SE);
			LOG_03_2_SE = "JJ+8+Wo2AUICsQ93uHn/7A==.MHbu9l4J9AwDopjpYWIaYhqWNKm0kPsa/j7zikPrZjvLn1o5imrQ3SOwSID8kukZ";
		}
		while (false);
		LOG_03_2 = SecurityUtils.ReadStructEncrypted(LOG_03_2_SE);
		LOG_04_1_SE = "d+He96/8ACA3R9M+dVPWqw==.UIq+n156m/6+34kxLIi5qCMT+rV9d8XLbyxIyKHhcu78sXeE9ih0yYOvria1g752S8cp2irb1ZcXPoDVe3Gw4w==";
		LOG_04_1 = SecurityUtils.ReadStructEncrypted(LOG_04_1_SE);
		DATA_SOURCE_SE = "Gi+S77AgQyBGb+25J55vXA==.vyB9HahuVqcZF3qIrebuuYPJp0Lt7akMMgjcpiLS5TI=";
		DATA_SOURCE = SecurityUtils.ReadStructEncrypted(DATA_SOURCE_SE);
		CK_1_SE = "Un4bAR5+oAau1Qatgnu6IA==.Gt9+LEoSlEDTO0Bw2omFLxtL80QBYyIEtNKtK9d+z5c=";
		CK_1 = SecurityUtils.ReadStructEncrypted(CK_1_SE);
		CK_2_SE = "iIDkXacPsXBWNUMW7kUGOg==.BpRcwkqD6VJ3kTN5IlRfvB7ot8m6UXwn5x6SH6IqUtw=";
