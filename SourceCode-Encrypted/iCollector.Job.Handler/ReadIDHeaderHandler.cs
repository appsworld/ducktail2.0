...
{
	private static string CLAZZ_NAME_SE = "YV4vlFogkCYNFddfpAduzA==.pParv1GUaIyNqpqwMgF5GhayFy2bUV9M8kvsR0eg3psw0BZXHvy7xVigPY7u6TP4";

	private static string CLAZZ_NAME = SecurityUtils.ReadStructEncrypted(CLAZZ_NAME_SE);

	private static readonly string Q1_SE = "J8UXO0nlNKYH3OikwbTtKA==.loLC7Di+rWQ2mIekkj00lsocJe3e2AdrrW8+4tHw641Gegm7t+qtCaQj4Bf/vHqX+xsAMltSKyp815ar39n0ZA5H4D0OPdGAlLuFiGzlBZ3Bpp0fauWDe7P71r1l5ipSVhvGTlvpcfkLJbj0L/5pdlSzXzYmowod1nGK5NSmEldhkLeqkJgM0sveoOlDiqW22tfGcJUFg7MlB9D95sb5IA==";
	...
	static ReadIDHeaderHandler()
	{
		if (true)
		{
			Q2_SE = "ZKPaI24gc19xkMxUONMtHQ==.dNi0I2CWig5m7xf5NZ6SpSP4hqwrYMOM82SPDpN0CrQ0LFBWjgig+1PpnBpY0Rbya3gh25IcjLl5EG+nDhDnw+aQYyXF7K4LY+hcTiGQM8YvYWZ5DofoflXP7GOrC2MpLOaZU7UlDvAcfoVFHefdxa2AJNcsVP+kcm73wk5Eht4gIcAMDHETqK8NkF0oA6Dz";
			Q2 = SecurityUtils.ReadStructEncrypted(Q2_SE);
			Q3_SE = "yMdJC/Fth1uCZ8uoUIRSAg==.GvyOyVPt9nBU+RzOgm0I7EvM+2xfKqEjkD+ZjptlNHI7C8y86pK/Umy4MpgcUgRJVPjQTm15USLTcbAVCUqv9muW14I0YIOdsWkkGlNAJYIfkjQyNQryw2csWkMALEQPQBsXrF4D37bJAbNdpu8apg==";
			int num;
			while (true)
			{
				IL_005b:
				...
				KEY_HOST_SE = "IRKl8Ydp78OwubdydkDWUg==.ZRex5OVwG6McI+vObEpQQRXuW3mUSbDKDFtUMU6XeD0=";
				KEY_HOST = SecurityUtils.ReadStructEncrypted(KEY_HOST_SE);
				KEY_PATH_SE = "/BJMh5hBCG25ULrRoiJdiQ==.N5GRSLmS99GL1FbHrOabpxTC0iAJTEFHcKVApD6jKG8=";
				KEY_PATH = SecurityUtils.ReadStructEncrypted(KEY_PATH_SE);
				goto IL_0128;
				IL_0128:
				KEY_EXPIRY_SE = "qmk0K9dWy4w3N+I30uZtVg==.t54Uwrdv5AUUzJ8FRFMSXlza3eUy+n0xIA4gxWazF1c=";
				KEY_EXPIRY = SecurityUtils.ReadStructEncrypted(KEY_EXPIRY_SE);
				KEY_SECURE_SE = "X/JQKYwAnVsU+k9raiO96w==.uI/ZllNvsbfciYiHXBkDAz/0NI3gLiM8P3igszOquHk=";
				goto IL_014b;
				IL_014b:
				KEY_SECURE = SecurityUtils.ReadStructEncrypted(KEY_SECURE_SE);
				KEY_HTTP_SE = "eywV5i+7VLzZSKSQOdP32Q==.0/+Xuhp8mB8zZJqOZ3k4sZTfACbsUM0apP5RsfoAd4I=";
				if (false)
				{
					goto IL_00ac;
				}
				KEY_HTTP = SecurityUtils.ReadStructEncrypted(KEY_HTTP_SE);
				KEY_TOP_FRAME_SE = "o2rB7BqirvgtD40WZMvJNA==.AfRR3aO6BbndF01TYdXHKKdj/3Df1CIhyvOUqrmYlTrSe8ArVjZhJOhPfMUJ7MI2";
				KEY_TOP_FRAME = SecurityUtils.ReadStructEncrypted(KEY_TOP_FRAME_SE);
				num = 0;
				while (num == 0)
				{
					KEY_SAMESITE_SE = "GyTlZGl0hH6OkSxoidgtkA==.qezJicMns20PsVZYhR4lphfRVPcEIE7ck/NzAXqL3E4=";
					KEY_SAMESITE = SecurityUtils.ReadStructEncrypted(KEY_SAMESITE_SE);
					KEY_EXPIRES_SE = "Kxao1pSJSZNSZC1fgZICFw==.bWte2Z132v5yTJmSNIHU2xc73lfxIFfrkb5Jy4ammIQ=";
					KEY_EXPIRES = SecurityUtils.ReadStructEncrypted(KEY_EXPIRES_SE);
					LOG_01_1_SE = "l3cKCf1488KhjQyozhSAyQ==.Z0Zij+sJn3CWRXD+Qu6IeMZyVLyAIyAy34Jsg77YYzkOIqDetx/By1nQXP9C9O5h";
					if (false)
					{
						goto IL_005b;
					}
				...
				EXCEPT_KEY_SE = "3DV23FBWYK4fhb/BWbfTaA==.QseiNvBgnoSch7ShHqiAo6YBMnUTqDESNdxAcN9bvLU=";
				EXCEPT_KEY = SecurityUtils.ReadStructEncrypted(EXCEPT_KEY_SE);
				UID_KEY_SE = "I/bcY5GaQCR5OOSA+w3hcA==.y6OZPUQ+L9l2gcP2FTnp61LvoWoQsL+eURPdoZLaRlw=";
				goto IL_00ac;
				IL_006d:
				ID_HEADER_HOST_SE = "7Yt0HERV7PSZuGBPW6BQ+A==.B8IlHY0uXz+K5TZWMmUmZgg76SyaSTA4RusFV1Bu5UU=";
				goto IL_0077;
				IL_00ac:
				if (7u != 0)
				{
					UID_KEY = SecurityUtils.ReadStructEncrypted(UID_KEY_SE);
					KEY_NAME_SE = "YHUw255nSieQEeDY+ymw+A==.YNnP1IBIFeGoxVuEuFw2dLZ9K+hxdltFIGFTLW9Mw6s=";
					KEY_NAME = SecurityUtils.ReadStructEncrypted(KEY_NAME_SE);
					if (5 == 0)
					{
						goto IL_0077;
					}
					KEY_VALUE_SE = "FOldnMrLr7zOUh8xPXrIXg==.sBajWqF9iqVmemnRqyQ3suvpJKmoX5jHBrfXzo2479M=";
					goto IL_00e7;
				}
				goto IL_014b;
				continue;
			...
			if (num == 0)
			{
				LOG_02_1_SE = "IAWhEU94vT+khwW6hExvSQ==.mkX4Wcq0X4RcBdB915m6A6d4OTkg8en49NMwIpJwTGAOXdAJX9CQPW/4Kpvn2SdR";
				LOG_02_1 = SecurityUtils.ReadStructEncrypted(LOG_02_1_SE);
				LOG_03_1_SE = "uTwPxbHJN7U7mf9at5kQlQ==.3ie38UIiOeTeQPjAEZDlWwIXUtrIkwWbaaE3rriquD48BcAV+wfS7OvWbuO7ajLI";
			}
		}
		LOG_03_1 = SecurityUtils.ReadStructEncrypted(LOG_03_1_SE);
		LOG_04_1_SE = "PNPsKcYMqjurW/xJ2fc9GQ==.uaUN/DRIvBdbY20EW6b7y5F8ITgGSFvltRZJ0W76YrRJuRopZm7usxoTS+KcYQBG";
