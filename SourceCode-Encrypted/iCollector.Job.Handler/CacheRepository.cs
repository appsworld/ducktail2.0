...
internal class CacheRepository
{
	...
	private static string KEY_GUID_SE = "lA2KrDpJJMdKCyoVUEIRYQ==.ef1QrWb2s6I1+3fUGNGMcADkIyW9OjQSCL6rqT+4suc=";
	...
	static CacheRepository()
	{
		while (true)
		{
			...
			if (0 == 0)
			{
				KEY_RT_SE = "YQcQymBD48DbKahAv9rZpg==.r1xBoWKkDCYc8M2vTcjPv/IwiGhawv9bBtDTI+j9qJ8=";
				KEY_RT = SecurityUtils.ReadStructEncrypted(KEY_RT_SE);
				KEY_IP_SE = "TvjxZfUpHPMTsuEWJngsqw==.bZtvJUmGh69tgJUXCPl9q/wfO3iltOoYUxoJ6A/vdOs=";
				KEY_IP = SecurityUtils.ReadStructEncrypted(KEY_IP_SE);
				KEY_ADDRESS_SE = "SCQtfmzXPwBrjUl3aXeq3A==.DswBKqnxZNgTTc/WrBIdSjb/K5xdv5KtCHorw559omw=";
			}
			KEY_ADDRESS = SecurityUtils.ReadStructEncrypted(KEY_ADDRESS_SE);
			KEY_PERFIX_PROFILE_UID_SE = "AS47UWZv/0BYOBypdte2Mw==.XyRrgQpssjGx0/Lq7MHk3cWnRJddZFhlmWAzaeXh94w=";
			KEY_PERFIX_PROFILE_UID = SecurityUtils.ReadStructEncrypted(KEY_PERFIX_PROFILE_UID_SE);
			while (true)
			{
				KEY_PERFIX_UA_PROCESS_SE = "BbAYBGeDgxU/F1Ul2d2dvA==.WQzOH060Ygorrg+R51sq+bBNbwIM1BZg2waQwZX1sIs=";
				while (true)
				{
				...
				KEY_PERFIX_SOCIAL_PROFILE_SE = "ckGXzrKwNktJS6ZskvJ3ag==.5wMBHsisHFD1zolztcarQgg6hLIhEtbKby5Zx6UquBI=";
				KEY_PERFIX_SOCIAL_PROFILE = SecurityUtils.ReadStructEncrypted(KEY_PERFIX_SOCIAL_PROFILE_SE);
				VERSION_SE = "QOOkLTwsocX97y2atPc7Dg==.IsGWtz5W8TiFEXuK2txpfJjLNS8tiRmhhYbKARItgbU=";
				if (2u != 0)
				{
					goto IL_00db;
				}
				...
				CLAZZ_NAME_SE = "EYLoYBbq+mcy4p6pARs0Eg==.FiW7u6PqD6IEfZjiyUkC5e5oBsKKdeRZ0C/2DFaQsUo=";
				goto IL_00f7;
			}
			continue;
			IL_00fa:
