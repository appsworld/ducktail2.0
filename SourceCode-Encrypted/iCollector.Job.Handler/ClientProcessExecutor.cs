...
internal class ClientProcessExecutor
{
	...
	static ClientProcessExecutor()
	{
		while (true)
		{
			...
			goto IL_0042;
			IL_0006:
			CLAZZ_NAME_SE = "ETBpT1TSOkn0yCh0QMccmQ==.PAeBC/S6s0xp+lMmY4/yQZ8uFj2iJ0UFAt3Rzryzldsj4dd/EZ18gqN0ALc228C7";
			goto IL_0010;
			IL_0042:
			if (num == 0)
			{
			...
			if (num == 0)
			{
				...
				ARGS_PARAM_SE = "VweW6sy6U348SCYROiz0IQ==.qx3g1OGADy8YVfpMbgDffax6Hc1dXX0/HxTVKqYDASqdFCILatHmbeV6C2m/XVpLKC/IR/Vfivx5e/gI6CzcVkLixb4Xj2iGGN6t0HZC0DM=";
				if (3 == 0)
				{
					goto IL_0006;
				}
