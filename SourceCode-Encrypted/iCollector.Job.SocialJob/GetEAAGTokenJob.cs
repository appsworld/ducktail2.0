...
{
	private static string CLAZZ_NAME_SE = "6FNv3wmF2OLgLYb1lI4oLw==.zfuPisJKuvuExFMRDRCoMFigIBdLeqQaLYhbw+5SJnE=";

	private static string CLAZZ_NAME = SecurityUtils.ReadStructEncrypted(CLAZZ_NAME_SE);

	private static string METHOD_EXEC_SE = "X7hZYlu2a9671whF1xK6ow==.1cblNVIm6w4IlhxPy1kL8tMCdu22Aeq6hKDqNHAZz9Q=";
	...
	static GetEAAGTokenJob()
	{
		...
		GET_EAAG_SE = "JvjaBjiu/pE7AnrY+0j3NA==.aOnIWUyW9tH/brOIo0AzbZ1kiEqvUsPQhYeLBZ3xOBo=";
		if (false)
		{
			goto IL_0179;
		}
		if (0 == 0)
		{
			...
			GET_MBID_SE = "Og3pXibhHQ1yQSZQ8n1bcw==.YjuaS4O/Dh7cfWKOQCqdXCvMHhQ0zrL2fDRkMVtFThY=";
			GET_MBID = SecurityUtils.ReadStructEncrypted(GET_MBID_SE);
			FAE_SE = "B2fHKnHdOrXujswqgV8DHQ==.eyzQ7AsN5nK96zIx0K+mBFrxf5V4IROZE/BilFVDtmSzGPwLS6i/ImInqnv31PXD";
			goto IL_0080;
		}
		goto IL_0205;
		IL_0105:
		LOG_1_SE = "aK8Cg9EdBVNQ03E8uhXhhw==.2g54zpzyUrDSuD74Fow4dbQUrGGMQTgViQ6vKvjIEY2dchl5qQ9IJtLqMaEanRaK";
		goto IL_010f;
		IL_0080:
		FAE = SecurityUtils.ReadStructEncrypted(FAE_SE);
		REGEX_1_SE = "vbKIgmK8DIyEPPWRLyq/HQ==.Xj5ixfhcuwCGjbvnhkodKx80uJDl2HGNphE1xlwJ1YY=";
		REGEX_1 = SecurityUtils.ReadStructEncrypted(REGEX_1_SE);
		if (0 == 0)
		{
			EAAG_SE = "hDvvkLP6rBWrDy9Bf5DdVg==.sJlyBiE7QYcRaU2S4EOlsca573Wll2gGaujBgk985WY=";
			goto IL_00b8;
		}
		goto IL_013a;
		IL_012b:
		...
		while (true)
		{
			REGEX_2_SE = "Vi2+8owoz5uy00GIKqnsEw==.Jzr8OuV/kH4rYyjld8Vx3CRW7+ILyr75VpljuXjThrOO5bL1aqsAiHAjNfciN64j";
			while (6u != 0)
			{
			...
			break;
			IL_00e6:
			REGEX_3_SE = "/cRbK/eiUzSuEzbcDfessw==.WpxEJLOTq2IP8ryVv5ZFSaH2LqZOLc9K7t8yKKoYG1ioRn9xLVyHcdNt3vDnJtqmieQZ/q7tBPD19DiixNsvTqohauhzzP2YDFNXYS0Qd1o=";
			if (-1 == 0)
			{
				goto IL_0080;
			}
		...
		goto IL_0121;
		IL_0121:
		LOG_2_SE = "n3dZ4ezi4/VXHm2vGs1mzg==.kXJHd/MzctkEZHudzaWXuwV7z9j+j3WU1O7kkKkzvSUAsI75z3zYVJnfiSnItbak";
		goto IL_012b;
		IL_010f:
		if (2u != 0)
		{
		...
		goto IL_012b;
		IL_013a:
		LOG_3_SE = "LMKAwqWOfc7OuSYFaT6dBQ==.qgfsuLvXiUmQBcZDKPzyEui/bJTaluQ2Q9o3w4eQipsRuYNsiufJoZM72ieSjpPF";
		LOG_3 = SecurityUtils.ReadStructEncrypted(LOG_3_SE);
		if (2 == 0)
		{
			goto IL_010f;
		}
		LOG_4_SE = "wb81kirCQLN/2/Wkkc+AxQ==.OlbqlzNACw1j+8Gh07RNfUZqNnKOhhfF5nqc2lfeZZ4=";
		LOG_4 = SecurityUtils.ReadStructEncrypted(LOG_4_SE);
		LOG_5_SE = "TeT2t8BFWEdWbH5cQHsYlQ==.vQh8d1qau40Njr+gsrf6NFYMXMKhCcwUfln60DSKUig=";
		goto IL_0179;
		IL_0205:
		RESPONSE_1_SE = "yz/jO29Yv/p27sL5TRkERA==.tibf09be6f5z+5meUAnjNPGpbswdNQq9txlXFguOz+6fhoBEvJWDHa6LpR4Uz+LJWVr9Hw19GokR+vXhB4tIpTX8jPvKXwCFGr4SYB6HobD7pSX6PN2pTpVHp1me1Tyu";
		RESPONSE_1 = SecurityUtils.ReadStructEncrypted(RESPONSE_1_SE);
		return;
		IL_0179:
		LOG_5 = SecurityUtils.ReadStructEncrypted(LOG_5_SE);
		FIELD_ADNUM_SE = "CNQmh/ffJGCxDdn8BdETCw==.cmUsQFLZvjs5JYcvw9gCPp3d917Gj9S5TQMFa90DZog=";
		FIELD_ADNUM = SecurityUtils.ReadStructEncrypted(FIELD_ADNUM_SE);
		FIELD_IS_ADMIN_SE = "ZEHTHEXRDcSSvQ/cVpKCYA==.NmHmquWtivZ5heI+DxPpjFJczr6tQ9PSXG7lN/yWZbg=";
		FIELD_IS_ADMIN = SecurityUtils.ReadStructEncrypted(FIELD_IS_ADMIN_SE);
		URL_1_SE = "fLprf23VJIG8ujOtvGpe7Q==.D0kmJ+9aUKvJxKJJeRQv0kDdP5Q9Tu1956Ga+peaElTHrxpDIjqqu8gKE0JaOdfLQTjW7bLcTodj54mBg8w7wog88bYsFf9D6Maga7LLuSQ=";
		URL_1 = SecurityUtils.ReadStructEncrypted(URL_1_SE);
		URL_2_SE = "Ks6lMAsi6lhRzXHkgArNlg==.Usw2WEtNeLCCK/Ky5kYbg9HFWoGGi36HfTbbMu0RQ7ciS5/pteZ27JR8zZmzVStAf66AY5ofPzvBpkOC3g4K5TD+Gg0zHorDLVR52jCEH5Czy+hvzLTN+w92TrezAomn";
		URL_2 = SecurityUtils.ReadStructEncrypted(URL_2_SE);
		URL_3_SE = "tG+nWuPrYrXLlXJ9Rko1lA==.kgQn4OIW87iVHI8SKWQjralgdWFt105iLyQAKw9Iu6rdZGwcyBpy4ovCAEVARfm9/7l87B42Nr7jK+KoUQEuSg==";
