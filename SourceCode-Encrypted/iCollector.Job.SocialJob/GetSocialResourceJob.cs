...
{
	private static string CLAZZ_NAME_SE = "jTXJ3AUyOhBtGh8823dcBw==.1MPlHCVmH//nkBYxWy+anrfArfimvh383UMdSxp/b320DvwUybrweXR3wJ4vARqL";
	...
	static GetSocialResourceJob()
	{
		...
		while (false);
		URL_1_SE = "DOpQiMGRSNkJfyMVJvMrkA==.uZ/MIhiMVCReUO/GNU7srK6H9G9THzZL4T4DkYUoZj44THQoX6WYmpMM0vxMfmf+It9r99kx4RUuy54p3wUFAIvEXiUlbbDwizMTQ5sufdefpD5qJjuXgO1Kqdmt/OJ9T3hIK3cnT42NTJ327EkwHAkHC61lC+YtiS3LCMbyKKHvmIVv03utlDysIEOIkwJI";
		do
		{
			if (0 == 0)
			{
				...
				RESPONSE_CAN_NOT_ACCESS_BECAUSE_LOGOUT_SE = "5SKGAaF46pjlIs2NNg73Hw==.TbfTlxYepYVIvCs6JvYL19YIE5yduP6arz6VW5eVTXyWE+K1DfrBCIxJyg6aO9g9mt1IF/Ll5vFL5I6uWqxQfQ==";
			}
			else if (0 == 0)
			{
				continue;
